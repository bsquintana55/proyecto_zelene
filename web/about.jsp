<%-- 
    Document   : about
    Created on : 11/11/2022, 07:04:49 PM
    Author     : solan
--%>
...
<html lang="es">
    ...
    <body class="d-flex flex-column">
        <main class="flex-shrink-0">
            ...
            <!-- Header-->
            <header class="py-5 fondo_sistema">
                <div class="container px-5">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xxl-6">
                            <div class="text-center my-5">
                                <h1 class="fw-bolder mb-3">Sistema de Información para la divulgación y manejo de eventos </h1>
                                <p class="lead fw-normal text-muted mb-4">
                                    ZELENE te ayudara a manejar tus eventos 
                                    y a poder unirte a estos, con una velocidad capaz de hacer 
                                    que no te pierdas de ninguno y 
                                    tambien quedaran encantados por la eficacia de este software.
                                </p>
